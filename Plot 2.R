#WEEK 1 PROJECt - Exploratory Data Analysis PLOT 2 
...
#Part 2 BUILD, PRINT and SAVE .bmp file of PLOT 2
###
par(mfrow=c(1,1))
plot(DateTime, as.numeric(household_power_consumption$Global_active_power)/500,pch="",main="Global Active Power", ylab="Global Active Power (kilowatts)")
